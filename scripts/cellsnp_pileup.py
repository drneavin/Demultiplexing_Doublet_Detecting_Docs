...
parser.add_argument("--minCOUNT", required = False, default = 20, help = "Minimum aggragated count [20].")
...
parser.add_argument("--countORPHAN", required = False, default = 0, help = "If use, do not skip anomalous read pairs.")
